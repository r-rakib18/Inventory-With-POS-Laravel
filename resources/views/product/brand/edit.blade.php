    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" enctype="multipart/form-data" action="{{url('/products/brand/update',$brand->id)}}" id="storeBrandInfo">
                    @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control " id="status" name="status" style="width: 100%;">
                                        <option {{($brand->status=='Published') ? 'selected':''}}>Published</option>
                                        <option {{($brand->status=='Drafts') ? 'selected':''}}>Drafts</option>
                                        <option {{($brand->status=='Pending') ? 'selected':''}}>Pending</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                    ...
                                    <div class="card border w-50">
                                        <div class="card-body">
                                            <img id="image_preview_container"
                                                 src="{{ ($brand->image)? asset('storage/brand/' . $brand->image):asset('storage/default.png') }}"
