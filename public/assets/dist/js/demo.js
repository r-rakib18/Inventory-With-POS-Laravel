...
(function ($) {
  ...
  var $text_sm_brand_container = $('<div />', { class: 'mb-1' }).append($text_sm_brand_checkbox).append('<span>BrandController</span>')
  ...
  $container.append('<h6>BrandController Logo Variants</h6>')
